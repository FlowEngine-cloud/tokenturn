...
export interface ConnectorHealth {
  ...
  rowCounts: { spendFacts: number; identities: number };
...
async function healthFor(
  vendor: string,
  displayName: string,
  defaultHistoryLimitDays: number,
  ...
  return {
    ...
    historyLimitDays: connectedRowOrNull?.history_limit_days ?? defaultHistoryLimitDays,
